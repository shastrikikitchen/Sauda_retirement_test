...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFFDD5044;
    private int tabDeactivateTextColor = 0xFF000000;
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle = Typeface.BOLD;

    private Typeface selectedTypeface = null;
    private Typeface unselectedTypeface = null;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        defaultTabLayoutParams.setMargins(0, 0, 0, 0);
    ...
    public void setMarginForTabs(){
        if(expandedTabLayoutParams != null) {
            expandedTabLayoutParams.setMargins(0, 0, 10, 0);
    ...
    public void changeTitle(final int position, String title) {
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTypeface(tabSwitch && i != 0 ? unselectedTypeface : selectedTypeface);
    ...
    private void updateActivateTab(final int position) {
        ...
        for(int i=0; i<tabCount; i++){
            ...
            if(v instanceof TextView) {
                TextView tab = (TextView)v;
                tab.setTypeface(position == i ? selectedTypeface : unselectedTypeface);
    ...
    public void setTypeface(Typeface selectedTypeface, Typeface unselectedTypeface) {
    ...
    public View getTab(int positon) {
        if(tabsContainer==null)
            return null;
        if(positon>tabsContainer.getChildCount())
            return  null;
        return tabsContainer.getChildAt(positon);
    }
